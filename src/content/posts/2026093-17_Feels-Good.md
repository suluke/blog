...
draft: false
description: "The world is on fire, but this blog feels lit."
tags: ['software', 'society']
---

I only have this blog for a couple of days now.
Yet, overall I am _very_ pleased with it so far.
...
All that in my second language, with no help by any LLMs (at so far).
Yes, some of my writing is clunky, some points don't come across as crisp as I want them to, yada yada.
What really counts is me having the discipline of sticking to it.
...
Actually, I have the feeling that for some of the people I want to read this blog the posting frequency might already be a bit too much.

The other half of what makes this experience so pleasant for me, however - and I don't mean this in a too self-absorbed way - is just how nice I find it to open up this blog's webpage in a browser.
...
And best of all, no attention-grabbing flashy ads that stick out like a sore thumb design-wise.

I went into the browser console to check what's being loaded.
